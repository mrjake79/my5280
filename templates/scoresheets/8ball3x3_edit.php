<?php
/**
scoresheet edit form for 8-Ball 3x3
...
<form action="<?php print admin_url('admin-ajax.php'); ?>" method='post' id='scoresheetForm'>
    <div class='scoresheet 8ball3x3'>
        ...
        <?php $numPlayers = $numberOfPlayers; $firstPlayer = 0; foreach($teams as $label => $info): ?>
            <div class='teamSection <?php print $label; ?>'>
                ...
                <div class='table rounds'>
                    ...
                    <?php for($i = $firstPlayer; $i < ($firstPlayer + $numberOfPlayers); $i++): ?>
                        <div class='row scores player<?php print $i; ?>'>
                            <?php for($j = 0; $j < $numberOfPlayers; $j++): ?>
                                <?php
                    ...
                    <div class='row handicaps'>
                        ...
                        <?php for($i = 0; $i < $numberOfPlayers; $i++): ?>
...
<script type='text/javascript'>
    ...
    {
        // Determine the round
        var iRound = Math.floor(homeGame / $numberOfPlayers);

        // Calculate the away game
        var awayGame = homeGame + iRound;
        if(awayGame >= ((iRound + 1) * $numberOfPlayers)) {
            awayGame -= $numberOfPlayers;
        }
        return awayGame;
    }
