<?php
/**
scoresheet view page for 8-Ball 3x3
...
<div class='scoresheet 8ball3x3'>
    ...
    <?php $numPlayers = $numberOfPlayers; $firstPlayer = 0; $iTeam = 0; foreach($teams as $label => $info): ?>
        <div class='teamSection <?php print $label; ?>'>
            ...
            <div class='table rounds'>
                    ...
                    <div class='row scores'>
                        <?php for($j = 0; $j < $numberOfPlayers; $j++): ?>
                            <?php
                                ...
                                if($iTeam):
                                    $iBreak -= $j;
                                    if($iBreak <= ($j * $numberOfPlayers)):
                                        $iBreak += $numberOfPlayers;
                                    endif;
                                endif;
                ...
                <div class='row totals'>
                    ...
                    <?php for($iRound = 0; $iRound < $numberOfPlayers; $iRound++): ?>
